 ...
 */
final class Version20230217180839 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE species (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, genus_id INTEGER DEFAULT NULL, taxonomy_id INTEGER NOT NULL, scientific_name VARCHAR(255) NOT NULL, vernacular_name VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_A50FF71285C4074C FOREIGN KEY (genus_id) REFERENCES genus (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
